...
export function SignUp() {
  ...
  return (
    <>
      {isLoading ? (<Loading />) : (
        <section className="bg-shape2 overflow-hidden flex items-center justify-center h-screen w-screen p-4">
          <motion.div
            initial={{ x: '13%' }}
            animate={{ x: '0' }}
            className="HeaderColor lg:w-[50%] lg:h-full py-10 px-0 rounded"></motion.div>
          ...
          <motion.div
            ...
            <header className="flex flex-col items-center">
              ...
              <header className="mt-0 text-lg text-gray-100">
                Crie uma nova conta
              </header>
